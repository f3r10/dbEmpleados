...
public class ListarParaActualizarActivity extends Activity {
	...
	setContentView(R.layout.activity_listar_para_actualizar);
	...
	public void irActualizar(Empleados empleado) {
		Intent intent = new Intent(this, ActualizarEmpleadoActivity.class);
		intent.putExtra("idEmpleado", empleado.getIdEmpleado());
